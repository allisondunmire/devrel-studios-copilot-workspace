...
description: >
  Use when the user wants to download and analyze YouTube livestream or video comments,
  including requests like "analyze YouTube comments", "download livestream chat",
  "YouTube sentiment analysis", "what did viewers say", "livestream recap", "compare
  streams", or "analyze playlist". Supports sentiment analysis, common-theme extraction,
  geographic breakdowns, and playlist URLs for multi-stream comparison across episodes.
---
...
```
python <PLUGIN_ROOT>/scripts/download-comments.py <YOUTUBE_URL>
```
...
```
python <PLUGIN_ROOT>/scripts/download-playlist.py <PLAYLIST_URL>
```
